...
public class Main {
    public static void main(String[] args) {
        ...
        Employee[] employees = {
                new EmployeeAndBonus("Иванов", PaymentTypes.RATE, 3000, true, 201),
                new EmployeeAndBonus("Сидоров", PaymentTypes.HOURLY, 800, true,120),
                new EmployeeAndBonus("Петров", PaymentTypes.JOB_PRICE, 5500, 230)
        };
        ((EmployeeAndBonus)(employees[employees.length/2])).setTugrikExchange(8);
